...
posts = [
    ...
    {
        'date': datetime.datetime(2018, 6, 18, 2, 10, 00),
        'author': 'mike',
        'name': 'Краски природы',
        'category': 'Природа',
        'content': 'Среди всего разнообразия природных ландшафтов встречаются такие места, где кажется, что попал в другой, сказочный, мир. Невероятное сочетание и буйство красок заставляют поверить в то, что природа специально собрала всю палитру в одном месте, чтобы показать свою красоту.'
    },
    {
        'date': datetime.datetime(2018, 6, 18, 2, 15, 00),
        'author': 'mike',
        'name': 'ЧМ в России',
        'category': 'Спорт',
        'content': 'Иностранцам, до этого не подозревавшим о существовании в России курортов (не медведей и минусовой температуры, а именно курортов), очень нравится. В основном встречаются испанцы, португальцы, бельгийцы и панамцы, но фан-зона в Сочи – срез всего чемпионата мира. Здесь исландец с флагом учил толпу фирменным хлопкам, мексиканцы в шляпах внедрялись в любую испанскую компанию, аргентинцы, колумбийцы, французы, уругвайцы просто соскучились по морю. '
    },
]
